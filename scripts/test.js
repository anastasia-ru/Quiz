(function () {
    const Test = {
        ...
        startQuiz() {
            ...
            this.prevButtonElement.onclick = this.move.bind(this, 'previous');
        ...
        // универсальная функция,которая должнапоказывать текущий вопрос
        showQuestion() {
        ...
        complete() {
            ...
            let userAnswers = () => {
                let answers = '';
                this.userResult.forEach(answer => {

                    answers += answer.chosenAnswerId + ',';
                })
                return answers.slice(0, -1);
            }

            const listUserAnswers = userAnswers();
